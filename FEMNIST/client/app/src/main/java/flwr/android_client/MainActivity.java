...
public class MainActivity extends AppCompatActivity {
    ...
    public void connect(View view) {
        ...
        if (TextUtils.isEmpty(host) || TextUtils.isEmpty(portStr) || !Patterns.IP_ADDRESS.matcher(host).matches()) {
            ...
            channel = ManagedChannelBuilder.forAddress(host, port).maxInboundMessageSize(60 * 1024 * 1024).usePlaintext().build();
            hideKeyboard(this);
        ...
        private void handleMessage(ServerMessage message, MainActivity activity) {
            ...
            try {
                ...
                if (message.hasGetParameters()) {
                    ...
                    Log.e(TAG, time + ": Handling FitIns");
                    ...
                    // Reload model if p value received from server is different and the current p value
                    ...
                    // Send the duration back to server as a metric
                    ...
                    Log.e(TAG, time+ " Handling EvaluateIns");
                    ...
                    Map<String, Scalar> metric = new HashMap<>();
                    // also send accuracy back to client as a metric
                ...
                Log.e(TAG, time+ " Response sent to the server");
                c = null;
            }
            catch (Exception e){
